...
$epora_blog_date = get_theme_mod( 'epora_blog_date', true );
$epora_blog_comments = get_theme_mod( 'epora_blog_comments', true );
$epora_blog_author = get_theme_mod( 'epora_blog_author', true );
$epora_blog_cat = get_theme_mod( 'epora_blog_cat', false );

?>

<div class="postbox__meta">
    <?php if ( !empty($epora_blog_author) ): ?>
