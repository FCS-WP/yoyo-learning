<?php
    ...
    $author_info = get_the_author_meta( 'epora_write_by');
    $facebook_url = get_the_author_meta( 'epora_facebook' );
    $twitter_url = get_the_author_meta( 'epora_twitter' );
    $linkedin_url = get_the_author_meta( 'epora_linkedin' );
    $instagram_url = get_the_author_meta( 'epora_instagram' );
    $epora_url = get_the_author_meta( 'epora_youtube' );
    $epora_write_by = get_the_author_meta( 'epora_write_by' );
