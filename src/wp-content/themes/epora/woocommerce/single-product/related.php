        ...
        <div class="row">
	        <div class="col-xl-6">
	           <div class="section-title mb-60">
	              <span class="tp-sub-title mb-20"><?php echo esc_html__( 'Related', 'epora'); ?></span>
					<?php
					$heading = apply_filters( 'woocommerce_product_related_products_heading', __( 'Related products', 'epora' ) );
