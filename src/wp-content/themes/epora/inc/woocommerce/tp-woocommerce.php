...
// single product
add_action( 'woocommerce_single_product_summary', 'epora_woo_rating', 5 );
...
if( function_exists( 'epora_blog_social_share' ) ){
add_action( 'woocommerce_single_product_summary', 'epora_blog_social_share', 50 );
}
...
if ( ! function_exists( 'epora_header_add_to_cart_fragment' ) ) {
    function epora_header_add_to_cart_fragment( $fragments ) {
        ob_start();
        ?>
...
add_filter( 'woocommerce_add_to_cart_fragments', 'epora_header_add_to_cart_fragment' );


// product-content
if( !function_exists('epora_loop_product_thumbnail') ) {
    function epora_loop_product_thumbnail( ) {
        global $product;
        ?>
...
add_action( 'woocommerce_before_shop_loop_item', 'epora_loop_product_thumbnail', 10 );

add_filter( 'woosq_button_html', 'epora_woosq_button_html', 10, 2 );
function epora_woosq_button_html( $output , $prodid ) {
...
/**
 * [epora_woo_rating description]
 * @return [type] [description]
 */


function epora_woo_rating() {
    global $product;
    ...
    $html .= '</div>';
    print epora_woo_rating_html( $html );
}

function epora_woo_rating_html( $html ) {
    return $html;
}
