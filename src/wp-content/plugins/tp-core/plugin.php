...
class TP_Core_Plugin {
	...
	public function register_widgets( $widgets_manager ) {
		...
		if ( class_exists( 'LearnPress' ) ) {
			foreach($this->tpcore_widget_list_learnpress() as $widget_file_name){
				require_once( TPCORE_ELEMENTS_PATH . "/{$widget_file_name}.php" );
			}
		}
	}
	...
	public function tpcore_widget_list_learnpress() {
		return [
			'tp-learnpress-course',
		];
	}
...
// Append tp font-awesome icons
        $tp_font_awesome_icons = array(
        ...
        $tabs['tp-font-awesome-icons'] = array(
            'name' => 'tp-font-awesome-icons',
            'label' => esc_html__('TP - Font Awesome Icons', 'tpcore'),
            'labelIcon' => 'tp-icon',
            'prefix' => '',
            'displayPrefix' => 'tp',
            'url' => TPCORE_ADDONS_URL . 'assets/css/font-awesome-pro.css',
            'icons' => $tp_font_awesome_icons,
            'ver' => '1.0.0',
        );   
        ...
        $tabs['tp-ui-icons'] = array(
            'name' => 'tp-ui-icons',
            'label' => esc_html__('TP - UI Icons', 'tpcore'),
            'labelIcon' => 'tp-icon',
            'prefix' => '',
            'displayPrefix' => 'tp',
            'url' => TPCORE_ADDONS_URL . 'assets/css/ui-icon.css',
            'icons' => $tp_ui_icons,
            'ver' => '1.0.0',
        );     
