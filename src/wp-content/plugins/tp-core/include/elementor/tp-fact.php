	...
	protected function register_controls() {
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default' => esc_html__('World Capture', 'tpcore'),
                'label_block' => true,
            ]
        );         
        $repeater->add_control(
            ...
            [
                ...
                'description' => tp_get_allowed_html_desc( 'intermediate' ),
                'type' => \Elementor\Controls_Manager::TEXTAREA,
                'default' => 'A traditional CCTV system comprises one',
                'label_block' => true,
            ]
        ); 
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    [
                        'tp_fact_title' => esc_html__('Project Progress', 'tpcore'),
                    ],
                    [
                        'tp_fact_title' => esc_html__('World Captured', 'tpcore')
                    ],
                    [
                        'tp_fact_title' => esc_html__('Team Functioinality', 'tpcore')
                    ],
                    [
                        'tp_fact_title' => esc_html__('Our Activities', 'tpcore')
                    ]
                ],
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'separator' => 'before',
                'selectors' => [
                    '{{WRAPPER}} .tp-fact' => 'text-align: {{VALUE}};'
                ]
            ]
        );
        $this->end_controls_section();
                           ...
                           <div class="tp-fact mb-10">
                              ...
                              <div class="fact-number">
                                ...
                                <?php if (!empty($item['tp_fact_number' ])): ?>
                                  <h2 class="counter"><?php echo tp_kses($item['tp_fact_number' ]); ?></h2>
                                <?php endif; ?>
                              ...
                              <div class="fact-content">
                                ...
                                <?php if (!empty($item['tp_fact_title' ])): ?>
                                <h4><?php echo tp_kses($item['tp_fact_title' ]); ?></h4>
                                <?php endif; ?>
