 ...
 */
if(!function_exists('epora_element_enqueue')){
    function epora_element_enqueue()
    {
    	
        wp_enqueue_style('tp-core', TPCORE_ADDONS_URL . 'assets/css/tp-core.css', null, '1.0');

    }
    add_action('wp_enqueue_scripts', 'epora_element_enqueue');
}
